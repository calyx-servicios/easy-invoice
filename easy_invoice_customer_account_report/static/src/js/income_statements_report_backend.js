odoo.define('easy_invoice_income_statements.income_statements_report_backend', function (require) {
    'use strict';
    ...
    var ReportWidget = require(
        'easy_invoice_income_statements.income_statements_report_widget'
        );
    ...
    core.action_registry.add(
        "income_statements_report_backend",
        report_backend
        );
