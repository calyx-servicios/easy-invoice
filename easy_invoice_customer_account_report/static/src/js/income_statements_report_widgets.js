odoo.define('easy_invoice_income_statements.income_statements_report_widget', function
(require) {
    'use strict';
    ...
    var incomeStatementsReportWidget = Widget.extend({
        events: {
    ...
    return incomeStatementsReportWidget;
